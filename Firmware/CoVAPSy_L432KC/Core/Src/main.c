...
int main(void)
{
  ...
  MX_SPI3_Init();
  /* USER CODE BEGIN 2 */
#if defined(MMA8451_ENABLE) && defined(MMA8451_TEST_ENABLE) && MMA8451_ENABLE && MMA8451_TEST_ENABLE
  // Start MMA8451 accelerometer test program
  MMA8451_Test(&hi2c1, &huart2, LD3_GPIO_Port, LD3_Pin);
#endif
